...
const InfoBanner = () => (
  <div className="max-w-xl mx-auto mb-3 px-3 py-2 rounded-lg bg-blue-50 border border-blue-200 shadow-sm text-blue-900 text-xs font-medium flex flex-col gap-1">
    <div>
      ⏳ If your video is taking time, check back in a few minutes or visit your{' '}
    ...
    <div>
      ...
      <a href="#/my-creations" className="font-semibold underline text-blue-700 hover:text-blue-900">My Creations</a> page after a few minutes. If it still doesn't generate, please mention it in feedback.
    </div>
  </div>
);
